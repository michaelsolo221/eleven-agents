...
<div class="test-banner">
  <span class="test-banner-title">⚠️ Test Email — Please Disregard ⚠️</span>
  This message was generated by an automated system test of the CGU Claims
  Lodgement integration. It is not a real customer claim and is unrelated to
  any genuine test or production activity — no action, filing, or follow-up
  is required.
</div>
<div class="container">
  <div class="header">
